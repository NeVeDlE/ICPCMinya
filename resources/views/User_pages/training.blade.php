        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
             <a href="{{URL::route('training-details', [$training->id]) }}"> <img src="{{asset('Trainings/'.$training['img'])}}" style="height: 400px;width: 400px" class="img" alt="..."></a>
              <div class="course-content">
                ...
                <h3><a href="{{URL::route('training-details', [$training->id]) }}">{{$training['name']}}</a></h3>
                <p>{{$training['description']}}</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="{{asset('Members/'.$training->item['img'])}} " style="height: 70px; width: 50px" class="img-fluid" alt="">
