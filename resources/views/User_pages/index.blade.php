...
<head>
    ...
    <title>ICPC Minya University - Index</title>
...
<section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <h1>Use Your Brain Today,<br>Role The World Tomorrow</h1>
        <h2>We are here to help you.</h2>
        <a href="/training" class="btn-get-started">Get Started</a>
    </div>
</section><!-- End Hero -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                    ...
                    <p class="fst" style="font-size: 20px">
                        ...
                        problem-solving skills which will help students to get jobs at Large software companies and pass
                        Technical Interviews where test your understanding
                        such as basic of programming language & oop & Algorithms
                        & Data Structure
                    </p>
        ...
        <div class="container">
            ...
            <div class="row counters">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="{{$trainees}}" data-purecounter-duration="1"
                          class="purecounter"></span>
                    <p>trainees</p>
                </div>

                <div class="col-lg-3 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="{{$trainings}}" data-purecounter-duration="1"
                          class="purecounter"></span>
                    <p>Trainings</p>
                </div>

                <div class="col-lg-3 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="{{$events}}" data-purecounter-duration="1"
                          class="purecounter"></span>
                    <p>Events</p>
                </div>

                <div class="col-lg-3 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="{{$mentors}}" data-purecounter-duration="1"
                          class="purecounter"></span>
                    <p>Mentors</p>
                </div>
